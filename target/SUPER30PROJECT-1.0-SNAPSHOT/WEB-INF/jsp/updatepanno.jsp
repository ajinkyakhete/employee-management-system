...
input:focus,select {
    ...
    <body>
        <form style="border:1px solid #ccc" action="processupdatepanno" method="post">
            <div class="container">
                ...
                <label for="emp_pan_no"><b>Enter new Pan No.</b></label>
                <input type="text" placeholder="Enter Employee Pan No." name="emp_pan_no"/>
