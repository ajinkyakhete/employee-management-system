...
input:focus,select {
    ...
    <body>
        <form style="border:1px solid #ccc" action="processupdatepincode" method="post">
            <div class="container">
                ...
                <label for="emp_pincode"><b>Enter new Pincode</b></label>
                <input type="text" placeholder="Enter Employee Pincode" name="emp_pincode"/>
