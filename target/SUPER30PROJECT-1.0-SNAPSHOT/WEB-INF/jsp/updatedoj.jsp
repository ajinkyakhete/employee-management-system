...
input:focus,select {
    ...
    <body>
        <form style="border:1px solid #ccc" action="processupdatedoj" method="post">
            <div class="container">
                ...
                <label for="emp_doj"><b>Enter new DOJ</b></label>
                <input type="date" placeholder="Enter Employee DOB" name="emp_doj"/>
