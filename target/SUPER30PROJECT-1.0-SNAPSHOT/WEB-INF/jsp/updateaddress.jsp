...
input:focus,select {
    ...
    <body>
        <form style="border:1px solid #ccc" action="processupdateaddress" method="post">
            <div class="container">
                ...
                <label for="emp_address"><b>Enter new Address</b></label>
                <input type="text" placeholder="Enter Employee Address name="emp_address"/>
