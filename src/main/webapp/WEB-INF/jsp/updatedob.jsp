...
input:focus,select {
    ...
    <body>
        <form style="border:1px solid #ccc" action="processupdatedob" method="post">
            <div class="container">
                ...
                <label for="emp_dob"><b>Enter new DOB</b></label>
                <input type="date" placeholder="Enter Employee DOB" name="emp_dob"/>
