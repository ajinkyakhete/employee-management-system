...
input:focus,select {
    ...
    <body>
        <form style="border:1px solid #ccc" action="processupdatemailid" method="post">
            <div class="container">
                <div class="subcontainer">
                    <h1>Welcome Admin</h1>
                    <h2>Update Mail ID</h2>
                </div>
                <hr>
                ...
                <label for="emp_mail_id"><b>Enter new Mail ID</b></label>
                <input type="text" placeholder="Enter Employee Mail ID" name="emp_mail_id"/>
