...
input:focus,select {
    ...
    <body>
        <form style="border:1px solid #ccc" action="processupdatemobileno" method="post">
            <div class="container">
                ...
                <label for="emp_mobile_no"><b>Enter new Mobile No.</b></label>
                <input type="text" placeholder="Enter Employee Mobile No." name="emp_mobile_no"/>
